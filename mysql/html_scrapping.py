...
class HTMLScrapping:
    ...
    def list_to_json(self, ICAO_all,IATA_all,name_all,country_all,city_all):
        '''
    ...
    def list_to_tuples(self, ICAO_all,IATA_all,name_all,taille_all,country_all,city_all):
        airport_tuples = list(zip(ICAO_all,IATA_all,name_all,taille_all,country_all,city_all))
        return airport_tuples

    def scrap_aeroport_data (self):
        ICAO_all, IATA_all, name_all, taille_all, country_all ,city_all = self.extract_info()
        airport_tuples = self.list_to_tuples(ICAO_all, IATA_all, name_all, taille_all, country_all ,city_all)
        return airport_tuples
     
    def tuples_to_csv(self, csv_file):
        # get aireport information sous forme de list de tuples
        data = self.scrap_aeroport_data ()
